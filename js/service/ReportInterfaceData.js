reportApp.service('ReportInterfaceData', function($window, $q, ReportData) {
    var InterfaceRate = function() {
        var self = this;
        this.q_firstSegIntData = function(hostname, int_name, from, until, duration, isset) {
        ...
        this.q_secondSegIntData = function(hostname, int_name, from, until, duration, isset) {
            var deferred = $q.defer();
            var from = from;
            var until = until;
            var duration = duration;
